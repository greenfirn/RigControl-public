@echo off
title RigControl Dashboard Server
cd /d "%~dp0"
...
REM Run the server
echo Starting RigControl Dashboard Server...
python rigcontrol_dashboard_server.py
...
:: run hidden
call .venv\Scripts\activate.bat
powershell -NoProfile -Command "Start-Process python -ArgumentList 'rigcontrol_dashboard_server.py' -WindowStyle Hidden"
