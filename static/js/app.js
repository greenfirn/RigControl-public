...
const VIEW_ONLY_DISABLED_IDS = [
    ...
    "btn-action-start", "btn-action-stop", "btn-action-restart", "btn-wd-enable",
    "btn-quick-a", "btn-quick-b", "btn-quick-c",
    "btn-reset",
    "btn-send-it-fs", "btn-save-fs", "btn-delete-fs", "btn-clear-fs",
    "btn-send-it-oc", "btn-save-oc", "btn-delete-oc", "btn-clear-oc", "btn-oc-add-row",
    "btn-save-wallet", "btn-delete-wallet", "btn-clear-wallet", "btn-fs-wallet-save-confirm",
    ...
    "btn-agentconf-apply", "btn-agentconf-clear",
    "btn-templates-config-apply",
