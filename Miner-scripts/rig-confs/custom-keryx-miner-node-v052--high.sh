  ...
  "items": [
    {
      ...
      "miner_config": {
        ...
        "user_config": "--high --resident-tree --models-dir /opt/miners/models --escrow-cert-file /opt/miners/escrow.cert --escrow-key-file /opt/miners/escrow.key --escrow-state-file /opt/miners/escrow_state.json --mining-address %WAL% --keryxd-address %URL% --stats-bind 127.0.0.1 --stats-port 3338",
